...
```{r Harvest fromaquaculture centers per region, echo = FALSE, fig.cap= 'Mean annual harvest per region from aquaculture centers between 2012 and 2017. Error bars represent one standard deviation. Data source: Harvests records from SERNAPESCA, 2018.' }
...
<!--- Include subsector analisis and value analisis for artisanal fishers -->

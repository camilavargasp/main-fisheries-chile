...
species_list <- read_csv(here("clean_databases/intermediate/species_list.csv")) %>% 
 ...
 landings_top_5 <- landings %>% 
  ...
  select(year, subsector, tons, species =nombre_cientifico_SERNAPESCA) %>% 

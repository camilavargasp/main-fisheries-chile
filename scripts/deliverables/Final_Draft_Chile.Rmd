...
We used landing records from SERNAPESCA to evaluate the main species in terms of landed volume over the last five years (2013-2017). 
...
We use data from Banco Central de Chile to reconstruct the percent of the regional GDP that comes from fisheries and graphed the average between 2013 and 2016. 

<!--- We may want to include exports estimates -->
 ...
 ** Main Fisheries for Aquaculture production **
 
 ** Regional Diferences in Landings **
 
<!--- Both industrial and artisanal -->

According to SERNAPESCA information in the last five years the most important fisheries in terms of
landings have been Anchovy (Engraulis ringens), Chilean jack mackerel (Trachurus murphy) and Araucanian herring (Strangomera bentincki) (Figure xx), all three of them mainly catch by the industrial fleet. This
pelagic fishes are mainly used to produce fish meal. Other species that contribute importantly to industrial
catch are merluza comun, merluza del sur, merluza de tres aletas, cod, merluza de cola, and langostinos
amarillo and colorado (S Table x).
In terms of aquaculture production the main species harvested in the last 5 years have been: Atlantic salmon
(Salmo salar), mussels (Mytilus chilensis) and coho salmon (Oncorhynchus kisutch) in descending order
(Figure x), among others (S Table x).
...
Fisheries products are one of the most important exported products of the country. Around 72% of the landings from fisheries and aquaculture are exported outside the country (@ifop_monitoreo_2015). IFOP valued the exportation of fisheries related products to $ 6,280 million dollars 2017 (@ifop_boletines_2017). This corresponded to ~ 9 % of the total value of national exportations. The most important exported type of marine products in terms of value are frozen and fresh followed by fish meal and dried algae (@ifop_boletines_2017). 

In terms of employment we estimated a total of ~100,000 job positions directly generated by the fisheries and aquaculture sector. Figure X shows the distribution of different types of participants among the different regions and by gender. Indirect employment per xx estimated to be. 

```{r employees per activity, echo= FALSE, fig.cap= 'Number of artisanal fishers in each region by gender. Source: National record of artisanal fishers (SERNAPESCA, 2018)'}

...
##Relevant species for Chile from mean_yield_body_part
...
##final yield database

yield_DHC <- mean_yield_c %>% 
  select(-min_yield, - max_yield) %>%
  rbind(mean_yield_bp_cl)

## Save yield dataset

write.csv(yield_DHC, here("clean_databases/intermediate/yield_DHC.csv"), row.names=F)

...
#setwd(~github/main-fisheries-chile/information) ##comment out when knitting

## Alternative: set here??
...
**Data downloaded** August 15, 2018. 

**Data range** 2014 -2016

Note: Data for 2017 was not available online but was requested to SERNAPESCA. They answered it will be uploaded by September. 
...
artisanal_month_2014 <- read_excel("information/raw_databases/SERNAPESCA/landings/landings_artisanal_per_species_month_2014.xls", sheet = "des_art_mes", range = "A5:M147", na = "-") %>% 
  gather(key = month, value = tons, 2:13)%>% 
  mutate (subsector = 'artisanal', year = 2014, region = 'national', species =  ESPECIE, international_waters = 0) %>% 
  select(subsector, year, region, month, species, tons, international_waters)
...
artisanal_month_2016 <- read_excel("raw_databases/SERNAPESCA/landings/landings_artisanal_per_species_month_2016.xls", sheet = "des_art_mes", range = "A5:M147", na = "-")%>% 
  gather(key = month, value = tons, 2:13)%>% 
  mutate (subsector = 'artisanal', year = 2016, region = 'national', species =  ESPECIE, international_waters = 0) %>% 
  select(subsector, year, region, month, species, tons, international_waters)

artisanal_month_2016 <- read_excel("information/raw_databases/SERNAPESCA/landings/landings_artisanal_per_species_month_2016.xls", sheet = "des_art_mes", range = "A5:M147", na = "-")%>% 
  gather(key = month, value = tons, 2:13)%>% 
  mutate (subsector = 'artisanal', year = 2016, region = 'national', species =  ESPECIE, international_waters = 0) %>% 
  select(subsector, year, region, month, species, tons, international_waters)

...
A: El símbolo – significa que las toneladas desembarcadas fueron 0 o menor que 0.5, por lo tanto en los Anuarios no se consideran

Q: Las estadísticas de desembarque para el sector industrial disponible en la sección Infomes y Datos/ Estadísticas/ Pesca Industrial incluye los datos, ubicados en a misma sección, para barcos fabrica o son estos número independientes?
...
1) if langings from AMERBs are included in the artisanal landings databases or if they are additive.

...
NO HUMAN CONSUMPTION ALGAE PRODUCT
...
##combine all algaes producs
product_algae_no_HC <- dplyr::bind_rows(algaseca_2013_p,algaseca_2014_p ,algaseca_2015_p, algaseca_2016_p , algaseca_2017_p) %>% 
  filter(!(species == 'NA')) %>% 
  mutate(tons = as.numeric(tons)) %>% 
  left_join(sp_index, by="species")
